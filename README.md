...
**В процессе разработки**, могут быть ошибки.

Сервис **семантического поиска** по исходному коду и документации. Один Go-бинарник — desktop GUI на Windows и два серверных транспорта:
