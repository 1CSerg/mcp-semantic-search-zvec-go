...
// closeResourcesFor releases native C handles for the given grammar specs
// (parser pools and compiled queries). Call only when no parsing is in flight
// for those specs.
func closeResourcesFor(specs map[string]*grammarSpec) {
