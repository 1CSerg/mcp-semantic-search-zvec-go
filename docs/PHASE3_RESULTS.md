...
| Phase 3 smoke (default 10 reconnect cycles) | `scripts/smoke-phase3.ps1` / `make smoke-phase3` | Pass (2026-06-08) |
| Phase 3 gate (50 reconnect cycles) | `.\scripts\smoke-phase3.ps1 -Reconnects 50` | Pass (2026-06-08) |
...
```powershell
.\scripts\smoke-phase3.ps1 -Reconnects 50
```
